    ...
    <>
      ...
      <div id="main-resume">
        ...
        <p>
          ...
          intense and fast-paced environment with employee technicians as well as high-profile
          clients, actors, and producers, to skillfully handle massive amounts of show-critical data
          and optimize networks to minimize time costs, resulting in high-quality entertainment
          production.
        </p>
        ...
        <p>
          ...
          Google Maps’ “Open Now” button, but much more personalized and fewer steps to get what you
          want.
        </p>
        <p>
          Technologies primarily used: Javascript, React, React-Redux, Node, Express, PostgreSQL,
        ...
        <ul>
          <li>
            Headed the department that designed, programmed, and operated lighting console programs
            and networks for film and television. I built extensive networks to distribute gigabits
            per second of show-critical lighting data to minimize time costs to productions.
          </li>
        </ul>
        <p>Projects include:</p>
        <ul>
          <li>East New York, Season 1 (Summer 2022 – Spring 2023), Produced by Warner Brothers</li>
        ...
        <ul>
          <li style={{ maxWidth: "80%" }}>
            ...
            electricity and lighting decision-making, technicians, and inventory during production.
          </li>
        </ul>
        <p>Projects include:</p>
        <ul>
