...
const Resume = () => {
  return (
    <div id="resume">
      ...
      <ul>
        <li>240-441-7689 | jdelbalzo99@gmail.com | New York, NY</li>
        <li>
          joedelbalzo.com | linkedin.com/in/joe-delbalzo/ |
          github.com/joedelbalzo
        </li>
      </ul>

      <h2>SUMMARY</h2>
      <p>
        Experienced former Chief Lighting Technician, lighting console
        programmer, and network designer with 15+ years in the film and
        television industry. Communicated regularly in an intense and fast-paced
        environment with employee technicians as well as high-profile clients,
        actors, and producers, to skillfully handle massive amounts of
        show-critical data and optimize networks to minimize time costs,
        resulting in high-quality entertainment production.
      </p>
      ...
      <p>
        ...
        find anything nearby that is open this minute, depending on their
        location and user preferences. Think Google Maps’ “Open Now” button, but
        much more personalized and fewer steps to get what you want.
      </p>
      <p>
        Technologies primarily used: Javascript, React, React-Redux, Node,
        Express, PostgreSQL, Sequelize, HTML, CSS, Material-UI, Google Places
        API
      </p>

      <h3>E-Commerce “A Script for Java”</h3>
      <p>
      ...
      <p>
        Led a team developing an e-commerce website for a small chain of coffee
        houses
      </p>
      <p>
        Technologies primarily used: Javascript, React, React-Redux, Node,
      ...
      <h3>Lighting Console Programmer | Local 52 | New York, NY</h3>
      <p>May, 2019 – Current</p>
      <ul>
        <li>
          Headed the department that designed, programmed, and operated lighting
          console programs and networks for film and television.
        </li>
        <li>
      ...
      <ul>
        <li>
          East New York, Season 1 (Summer 2022 – Spring 2023), Produced by
          Warner Brothers
        </li>
      ...
      <h3>Chief Lighting Technician | Local 52 | New York, NY</h3>
      ...
      <ul>
        ...
        <li>
          Tracing the Rope: Eva Hesse (Fall 2013), Directed by Marcie Begleiter
        </li>
      </ul>

      <h3>IATSE Local 52 Film and TV Electrician | Local 52 | New York, NY</h3>
      ...
      <ul>
        ...
        <li>
          The Jinx: The Life and Deaths of Robert Durst (Dec. 2014), Produced by
          HBO
        </li>
      </ul>
      ...
      <p>New York University, Tisch School of the Arts | May 2011</p>
      <p>Bachelor of Fine Arts, Film and Television</p>

      <p>Indiana University, Kelley School of Business | May 2018</p>
      <p>Master’s Certificate in Business Management</p>
      ...
      <ul>
        ...
        <li>
          Certified Cicerone® of the Cicerone Certification Program, May 2017
        </li>
      </ul>
    </div>
  );
