...
const DrinkProducts = () => {
      ...
      >
        ...
        >
          ...
          <CardActions sx={{ justifyContent: "center" }}>
            ...
            <Button component="span" size="small" onClick={() => _addToCart(drink, quantity)}>
              Add To Cart
            </Button>
          </CardActions>
        </CardActionArea>
  ...
  const _moreDetails = (drink) => {
    navigate(`/scriptforjava/menu/${drink.id}`);
  };
  ...
  const search = (ev) => {
    ...
    navigate(`/scriptforjava/menu/search/${JSON.stringify(_filter)}`);
  };
