...
const locations = [
  {
    ...
    imageUrl:
      "https://freight.cargo.site/t/original/i/039d199c7b1541b3e338143ee06a962c079d35889632996a874dabdd19b95282/devo.JPG",
  ...
  },
  {
    id: Math.floor(Math.random() * 100),
    imageUrl:
      "https://offloadmedia.feverup.com/secretnyc.co/wp-content/uploads/2018/03/10121937/58586699_10157279130757783_3633541610861494272_o.jpg",
    name: "Micro-Soft",
  ...
  },
  {
    id: Math.floor(Math.random() * 100),
    imageUrl:
      "https://d3emaq2p21aram.cloudfront.net/media/cache/venue_roundup_single_image_flex/uploads/%200Regular_Roundup/2018/4-April/SFCoffee/SightglassCoffee-AdamSzafranski-01.jpg",
    name: "FaceMash",
          ...
          return (
            ...
            >
              ...
              <CardActionArea sx={{ textAlign: "center" }}>
                <Button
                  component="span"
                  onClick={() => window.open(location.historyUrl)}
                  size="small"
                >
                  Location History
                </Button>
                <Button
                  component="span"
                  onClick={() => window.open(location.googleMaps)}
                  size="small"
                >
                  Google Maps
                </Button>
