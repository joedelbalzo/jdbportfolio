...
const Favorites = () => {
  ...
  //   ev.preventDefault();
  //   try{
  //       await dispatch(placesEditUserFavorites({placesAuth, place, notes, rating}));
  //       navigate(`/places/${id}`);
    ...
    <>
      <div>
        <div id="places-categoryContainer">
          ...
          {deletedFavorite ? (
            <div id="places-opensSoon">{deletedFavorite.name} just removed from favorites.</div>
          ) : (
            ""
          )}
          <div>
                ...
                <div key={place.id}>
                  ...
                  >
                    ...
                    <CardContent>
                      ...
                      {openSoon(30, place) ? (
                        <span id="places-opensSoon">but it opens soon, hang on!</span>
                      ) : (
                        ""
                      )}
                      {closingSoon(120, place) ? (
                        <span id="places-opensSoon">but it closes soon! go go go!</span>
                      ) : (
                        ""
                      )}
                    ...
                    <CardActions disableSpacing>
                      ...
                      >
                        {placesFavorites.includes(place) ? (
