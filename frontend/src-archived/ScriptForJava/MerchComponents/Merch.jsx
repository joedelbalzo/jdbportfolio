...
const Merch = () => {
  ...
  const merch = scriptMerches.find((d) => d.id === id);
  if (!merch) {
    return null;
  }
    ...
    <div id="scriptforjava-productDiv">
      <div id="scriptforjava-productDivLeft">
        <Card sx={{ maxWidth: 345 }}>
          <CardMedia component="img" height="345" image={merch.imageUrl} alt={merch.name} />
        </Card>
      </div>
      ...
      <div id="scriptforjava-productDivright">
        <Card sx={{ maxWidth: 345 }}>
          ...
          <Collapse in={expanded} timeout="auto" unmountOnExit>
            <CardContent>
              <Typography paragraph>{merch.description}</Typography>
            </CardContent>
          </Collapse>
        </Card>
      </div>
