...
const UserCreate = () => {
  ...
  return (
    <div className="css-login">
      <h3 className="css-proheader">Create Account</h3>
      <form onSubmit={registerUser}>
        ...
        <input value={password} onChange={(ev) => setPassword(ev.target.value)} type="password" name="password" />
        <label>Email</label>
        ...
        <button className="css-rainbowBtn">Create Account</button>
      </form>
